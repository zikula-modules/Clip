 ...
 * Define Class path
 */
define('Pagemaster_FILTERUTIL_CLASS_PATH', 'modules/pagemaster/classes/FilterUtil');

Loader::loadClass('PagemasterFilterUtil_Plugin', Pagemaster_FILTERUTIL_CLASS_PATH);
 ...
 */
class PagemasterFilterUtil extends PagemasterFilterUtil_Common {
     ...
     * @return object PagemasterFilterUtil object
     */
    public function __construct($args = array())
    {
        $this->setVarName('filter');
        parent::__construct($args);
        $this->plugin = new PagemasterFilterUtil_Plugin($this->addCommon(), array('Default' => array()));
