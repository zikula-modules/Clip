...
define('_PAGEMASTER_PUBTYPE_EDITFIELDS', 'Edit Publicationfields');
...
define('_PAGEMASTER_MANAGE_TITLE', 'Manage Publicationtypes');
define('_PAGEMASTER_CREATEPUBFIELDS', 'Manage Publicationfields');
define('_PAGEMASTER_ADDPUBFIELDS', 'Add Publicationfields');
define('_PAGEMASTER_EXISTINGPUBFIELDS', 'Existing Publicationfields');
define('_PAGEMASTER_CREATEPUBTYPE', 'Create a new Publicationtype');
define('_PAGEMASTER_CREATEEDIT_TID', 'Create / Edit Publicationtype');

define('_PAGEMASTER_EDIT_FIELDS', 'Publicationfields');
define('_PAGEMASTER_LIST', 'Publicationslist');
...
define('_PAGEMASTER_PUBFIELD_TITLE_HELP', 'Titel (is shown e.g. in the Automaticaly generated Templates)');
...
define('_PAGEMASTER_PUBFIELD_ACTIONS', 'Actions');
...
define('_PAGEMASTER_TITLE_HELP', 'Title of the Publicationtype');
define('_PAGEMASTER_DESCRIPTION', 'Description');
define('_PAGEMASTER_DESCRIPTION_HELP', 'Description of the Publicationtype');
define('_PAGEMASTER_LISTCOUNT', 'Listcount');
define('_PAGEMASTER_LISTCOUNT_HELP', 'After how many Publications the list will be paged. 0 for no paging');
define('_PAGEMASTER_SORTFIELD', 'Sortfield');
...
define('_PAGEMASTER_EDITDATE', 'Edit date');
