...
define('_PAGEMASTER_CACHETID', 'Zwischenspeichern');
define('_PAGEMASTER_CACHETID_HELP', 'Durch diese Option werden die Publikationen in den pnRender Cache geschrieben um die Ladezeiten zu verkόrzen, diese Option ist unabhδngig von den pnRedner Einstellungen');
define('_PAGEMASTER_CACHESECONDS', 'Cache Zeit ');
define('_PAGEMASTER_CACHESECONDS_HELP', 'Wie lange sollen die Dateien Zwischengespeichert werden');
