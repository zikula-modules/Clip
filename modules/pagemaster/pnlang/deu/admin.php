...
define('_PAGEMASTER_PUBTYPES', 'Publikations typen');
define('_PAGEMASTER_PUBTYPE_EDITFIELDS', 'Publikations felder editieren');
define('_PAGEMASTER_PUBTYPE_EXISTING', 'Existierende Publikations typen');
