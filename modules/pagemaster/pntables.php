...
function pagemaster_pntables() {
	...
	/////////////////
	$pagemaster_relations = pnDBGetTablePrefix('pagemaster_relations') . '_pagemaster_relations';
	$pntable['pagemaster_relations'] = $pagemaster_relations;
	...
	$pagemaster_pubfields = pnDBGetTablePrefix('pagemaster_pubfields') . '_pagemaster_pubfields';
	$pntable['pagemaster_pubfields'] = $pagemaster_pubfields;
	...
	//////////////////
	$pagemaster_pubtypes = pnDBGetTablePrefix('pagemaster_pubtypes') . '_pagemaster_pubtypes';
	$pntable['pagemaster_pubtypes'] = $pagemaster_pubtypes;
	...
	//////////////////
	$pagemaster_revisions = pnDBGetTablePrefix('pagemaster_revisions') . '_pagemaster_revisions';
	$pntable['pagemaster_revisions'] = $pagemaster_revisions;
	...
	if ($dbconn->errorNo() != 0) {
		...
		$tablecolumncore['id'] = 'pm_id';
		$tabledefcore['id'] = 'I PRIMARY AUTO';
		$tablecolumncore['core_pid'] = 'pm_pid';
		$tabledefcore['core_pid'] = 'I NOTNULL';
		$tablecolumncore['core_online'] = 'pm_online';
		$tabledefcore['core_online'] = 'I4 NOTNULL';
		$tablecolumncore['core_indepot'] = 'pm_indepot';
		$tabledefcore['core_indepot'] = 'I4 NOTNULL';
		$tablecolumncore['core_revision'] = 'pm_revision';
		$tabledefcore['core_revision'] = 'I NOTNULL';
		$tablecolumncore['core_showinmenu'] = 'pm_showinmenu';
		$tabledefcore['core_showinmenu'] = 'I4 NOTNULL';
		...
		$tabledefcore['core_hitcount'] = 'I(9) DEFAULT 0';
