...
<div class="z-admincontainer">
    ...
    <table class="z-admintable">
        <thead>
            <tr>
                <th>
                    <a href="{modurl modname='PageMaster' type='admin' func='publist' tid=$core_tid orderby=$orderby_core_pid}">
                        {gt text='PID'}
                    </a>
                </th>
                <th>
                    <a href="{modurl modname='PageMaster' type='admin' func='publist' tid=$core_tid orderby=$orderby_core_title}">
                        {gt text='Title'}
                    </a>
                </th>
                ...
                <th>{gt text='State'}</th>
                <th>
                    <a href="{modurl modname='PageMaster' type='admin' func='publist' tid=$core_tid orderby=$orderby_core_author}">
                        {gt text='Author'}
                    </a>
                </th>
                <th>{gt text='Online'}</th>
                <th>
                    <a href="{modurl modname='PageMaster' type='admin' func='publist' tid=$core_tid orderby=$orderby_cr_date}">
                        {gt text='Creation date'}
                    </a>
                </th>
                <th>
                    <a href="{modurl modname='PageMaster' type='admin' func='publist' tid=$core_tid orderby=$orderby_lu_date}">
                        {gt text='Update date'}
                    </a>
                </th>
        ...
        <tbody>
            ...
            <tr class="{cycle values='z-odd,z-even'}">
                ...
                <td>
                    <a href="{modurl modname='Users' type='admin' func='modify' userid=$pubitem.core_author}">{usergetvar name="uname" uid=$pubitem.core_author} </a>
                </td>
