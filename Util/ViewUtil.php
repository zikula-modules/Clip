...
class ViewUtil
{
     ...
     */
    public function getvalue($params, Zikula_View $view)
    {
     ...
     * @return mixed
     */
    public function getcategory($params, Zikula_View $view)
    {
     ...
     * @return mixed
     */
    public function getsubcategories($params, Zikula_View $view)
    {
        $cid = isset($params['cid']) ? (int) $params['cid'] : 0;
