...
class Group extends \Zikula_Form_Plugin_TextInput
{
    // plugin definition
    public $pluginTitle;
...
' . '            </span>';
    ...
    public function getConfigHtml($field, $view)
    {
        ...
        // operator to use
        $operators = array('likefirst' => $this->__('in the beggining'), 'search' => $this->__('inside the group name'));
        $html .= '<div class="z-formrow">
