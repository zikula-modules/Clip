...
class Matheo_Clip_Model_Pubtype extends \Doctrine_Record
{
    ...
    public function setTableDefinition()
    {
        ...
        $this->hasColumn(
            'fixedfilter as fixedfilter',
            'string',
            255
        );
        $this->hasColumn(
            'defaultfilter as defaultfilter',
            'string',
            255
        );
        $this->hasColumn(
            ...
            'integer',
            4,
            array('notnull' => true, 'default' => 15)
        );
        $this->hasColumn(
            'cachelifetime as cachelifetime',
            'integer',
            8,
            array('notnull' => true, 'default' => 0)
        );
        $this->hasColumn(
            'sortfield1 as sortfield1',
            'string',
            255
        );
        ...
        $this->hasColumn(
            'enableeditown as enableeditown',
            'boolean',
            null,
            array('notnull' => true, 'default' => 0)
        );
        $this->hasColumn(
            'enablerevisions as enablerevisions',
            'boolean',
            null,
            array('notnull' => true, 'default' => 0)
        );
    ...
    public function getHooksEventName(
        $hooktype = 'display_view',
        $category = 'ui_hooks',
        $subarea = ''
    ) {
    ...
    public function getHooksAreaName(
        $category = 'ui_hooks',
        $subarea = '',
        $type = 'subscriber'
    ) {
    ...
    {
        $default = array('list' => array('load' => false, 'onlyown' => true, 'checkperm' => false), 'display' => array('load' => true, 'onlyown' => true, 'checkperm' => true), 'edit' => array('load' => true, 'onlyown' => true, 'checkperm' => false));
