...
class AjaxController extends \Zikula_Controller_AbstractAjax
{
    ...
    public function editgroup()
    {
        ...
        $this->view->assign('mode', $mode)->assign('pos', $pos)->assign('group', $group)->assign('languages', ZLanguage::getInstalledLanguages());
        $result = array('action' => $mode, 'result' => $this->view->fetch('clip_ajax_groupedit.tpl'));
    ...
    public function count($args)
    {
        ...
        $args = array('count' => isset($args['count']) ? $args['count'] : FormUtil::getPassedValue('count'), 'field' => isset($args['field']) ? $args['field'] : FormUtil::getPassedValue('field'));
        //// Validation
        ...
        if ($args['count']) {
            Doctrine_Core::getTable('ClipModels_Pubdata' . $apiargs['tid'])->incrementFieldBy(
                $args['count'],
                $apiargs['pid'],
                'core_pid'
            );
