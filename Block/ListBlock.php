 ...
 * List Block.
 */
class ListBlock extends \Zikula_Controller_AbstractBlock
{
    /**
     * Initialise block.
     */
    ...
    {
        return array('module' => 'Clip', 'text_type' => $this->__('Clip List'), 'text_type_long' => $this->__('Clip list of publications'), 'allow_multiple' => true, 'form_content' => false, 'form_refresh' => false, 'show_preview' => true);
    }
    ...
    public function modify($blockinfo)
    {
        ...
        return $this->view->assign('vars', $vars)->assign('pubtypes', $pubtypes)->assign('pubfields', $pubfields)->fetch('clip_block_list_modify.tpl');
    }
    ...
    {
        $vars = array('tid' => FormUtil::getPassedValue('tid'), 'orderBy' => FormUtil::getPassedValue('orderBy'), 'orderDir' => (int) FormUtil::getPassedValue('orderDir'), 'listfilter' => FormUtil::getPassedValue('listfilter'), 'listCount' => FormUtil::getPassedValue('listCount'), 'listOffset' => FormUtil::getPassedValue('listOffset'), 'template' => FormUtil::getPassedValue('template'), 'cachelifetime' => FormUtil::getPassedValue('cachelifetime'));
