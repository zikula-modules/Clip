...
class RandomPubBlock extends \Zikula_Controller_AbstractBlock
{
    ...
    public function display($blockinfo)
    {
        ...
        if (!$this->view->template_exists($template)) {
            ...
            $this->view->setForceCompile(true)->setCaching(Zikula_View::CACHE_DISABLED)->assign('clip_generic_tpl', true)->assign('template_generic_code', Clip_Generator::pubdisplay($vars['tid'], true, true));
        }
