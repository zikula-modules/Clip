 ...
 * RandomPub Block.
 */
class Clip_Block_RandomPub extends Zikula_Controller_AbstractBlock
{
    /**
     * Initialise block.
     */
    ...
    public function info()
    {
        return array(
            'module'         => 'Clip',
            'text_type'      => $this->__('Random Pub'),
            'text_type_long' => $this->__('Random publication block'),
            'allow_multiple' => true,
            'form_content'   => false,
            'form_refresh'   => false,
            'show_preview'   => true
    ...
    public function display($blockinfo)
    {
        ...
        if (!empty($cachelt)) {
            ...
            $cacheid = 'tid_'.$vars['tid'].'/randompub'
                .'/bid_'.$blockinfo['bid']
        ...
        $this->view->assign('pubdata', $publist->getFirst())
        ...
        if (!$this->view->template_exists($template)) {
            ...
            $this->view->setForceCompile(true)
                       ...
                       ->assign('template_generic_code', Clip_Generator::pubdisplay($vars['tid'], true, true));
        }
