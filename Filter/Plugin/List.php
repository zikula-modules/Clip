...
class List extends ListDropdown
{
    ...
    public static function loadParameters(
        ...
        foreach ($allCats as $cat) {
            ...
            $res = ModUtil::apiFunc('Clip', 'user', 'getall', array('tid' => $filter->getTid(), 'countmode' => 'just', 'filter' => "{$list->field}:{$op}:{$cat['id']},core_online:eq:1,core_visible:eq:1,core_intrash:eq:0", 'checkperm' => false, 'handleplugins' => false));
