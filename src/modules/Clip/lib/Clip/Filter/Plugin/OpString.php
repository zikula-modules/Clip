 ...
 */
class Clip_Filter_Plugin_OpString extends Clip_Filter_Plugin_ListDropdown
{
    /**
     * Enabled operators.
     *
    ...
    {
        $this->ops = array(
            'eq'        => $this->__('is equal to'),
            'ne'        => $this->__('is different to'),
          //'lt'        => '<',
          //'le'        => '<=',
          //'gt'        => '>',
          //'ge'        => '>=',
            'search'    => $this->__('contains'),
            'like'      => $this->__('is like'),
            'likefirst' => $this->__('begins with'),
