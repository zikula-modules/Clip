...
class ClipPublistContentType extends \Content_AbstractContentType
{
    ...
    public function display()
    {
        ...
        $args = array('tid' => $this->tid, 'orderby' => $orderstr, 'filter' => !empty($this->filter) ? $this->filter : '()', 'itemsperpage' => (int) $this->numitems > 0 ? $this->numitems : 5, 'startnum' => !empty($this->offset) ? $this->offset : 0, 'template' => !empty($this->tpl) ? $this->tpl : 'block', 'cachelifetime' => isset($this->clt) ? $this->clt : null);
